...
ggplot(data = TTM,aes(x = Order, y =  Abundance))+ geom_boxplot() + labs(x = "Order" , y = "Abundance", title = "Frequency of Abundance By Each Mammaml Order") + theme_classic() + coord_flip()
ggsave("BoxPlot.pdf")
